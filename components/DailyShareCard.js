...
export default function DailyShareCard({ match }) {
  ...
  async function shareCard() {
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
      ...
      <circle cx="238" cy="274" r="88" fill="#171812" stroke="#ffe812" stroke-opacity=".7" stroke-width="3"/><text x="238" y="295" fill="#ffe812" font-size="58" font-family="Arial" font-weight="800" text-anchor="middle">${escapeSvg(initials(match.homeTeam))}</text>
      <circle cx="962" cy="274" r="88" fill="#171812" stroke="#ffe812" stroke-opacity=".7" stroke-width="3"/><text x="962" y="295" fill="#ffe812" font-size="58" font-family="Arial" font-weight="800" text-anchor="middle">${escapeSvg(initials(match.awayTeam))}</text>
  ...
  return <aside className="daily-share-card">
    ...
    <div className="share-card-match"><strong>{match.homeTeam}</strong><i>VS</i><strong>{match.awayTeam}</strong></div>
