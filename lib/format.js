...
// Maç sayfası SEO slug'ı — ör. "galatasaray-fenerbahce-2026-09-20" (kullanıcı
// isteği, 2026-08-24). Sayısal fixture id yerine anlamlı bir URL. Geri
// çözümleme (slug -> fikstür) için ayrı bir kolon/tablo TUTULMUYOR: slug'ın
// son 10 karakteri her zaman tarih, o günün fikstürleri çekilip her birinin
// KENDİ slug'ı yeniden üretilip (bu fonksiyonla) tam eşleşme aranıyor — bkz.
// app/mac/[slug]/page.js.
export function matchSlug(homeTeam, awayTeam, kickoffIso) {
  return `${slugify(homeTeam)}-${slugify(awayTeam)}-${istDateKey(kickoffIso)}`;
}
